...
const LogIn = () =>{
    ...
    <div className="bg-pt-primary text-white flex flex-col items-center">
        ...
        <label htmlFor="user-input" className="bg-pt-primary text-white text-3xl md:text-5xl text-center p-4 flex justify-center ">Enter username</label>
        <input id="user-input" type="text" onChange={handleChange} className="text-black min-h-[40px]  w-[250px]"/>
